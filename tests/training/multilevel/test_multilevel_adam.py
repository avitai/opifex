...
def test_multilevel_adam_resize_generic_object():
    ...
    real_state = optimizer.opt_state[0]  # pyright: ignore[reportOptionalSubscript,reportIndexIssue]
    mock_state = MockAdamState(real_state.count, real_state.mu, real_state.nu)  # pyright: ignore[reportAttributeAccessIssue]
