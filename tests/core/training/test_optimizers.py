...
class TestScheduleCreation:
    ...
    def test_create_cosine_schedule(self):
        ...
        assert float(schedule(1000)) <= 0.01  # type: ignore[arg-type]
        assert float(schedule(1000)) >= 0.001  # type: ignore[arg-type]
    ...
    def test_create_exponential_schedule(self):
        ...
        assert float(schedule(100)) < 0.1  # type: ignore[arg-type]
        assert float(schedule(200)) < float(schedule(100))  # type: ignore[arg-type]
    ...
    def test_create_warmup_cosine_schedule(self):
        ...
        assert float(schedule(500)) < 0.01  # type: ignore[arg-type]
