...
class TestManifestGenerator:
    ...
    def test_service_manifest_generation(self):
        ...
        manifest = generator.generate_service(port=8000, target_port=8000, service_type="ClusterIP")
...
class TestAutoScaler:
    ...
    def test_vpa_manifest_generation(self):
        ...
        autoscaler = AutoScaler(namespace="opifex-production", deployment_name="opifex-server")
        manifest = autoscaler.generate_vpa(update_mode="Auto", cpu_min="100m", memory_min="128Mi")
