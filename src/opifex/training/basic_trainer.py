...
def create_progress_bar_callback(description: str = "Training", **tqdm_kwargs):
    ...
    Example:
        config = TrainingConfig(
            progress_callback=create_progress_bar_callback("Training UNO")
        )
    """
    pbar = None
    ...
    def progress_callback(progress_info: dict):
        ...
        val_loss = progress_info.get("val_loss")
