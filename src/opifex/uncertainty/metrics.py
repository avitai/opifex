...
def predictive_entropy(*, ensemble_probabilities: Any) -> Any:
    ...
    warn_deprecated(f"{_HERE}.predictive_entropy", f"{_HOME}.predictive_entropy")
...
def mutual_information(*, ensemble_probabilities: Any) -> Any:
    ...
    warn_deprecated(f"{_HERE}.mutual_information", f"{_HOME}.ensemble_mutual_information")
...
def interval_score(*, lower: Any, upper: Any, targets: Any, alpha: float) -> Any:
    ...
    warn_deprecated(f"{_HERE}.interval_score", f"{_HOME}.interval_score")
...
def winkler_score(*, lower: Any, upper: Any, targets: Any, alpha: float) -> Any:
    ...
    warn_deprecated(f"{_HERE}.winkler_score", f"{_HOME}.winkler_score")
...
def anees(*, predicted_means: Any, predicted_covariances: Any, references: Any) -> Any:
    ...
    warn_deprecated(f"{_HERE}.anees", f"{_HOME}.anees")
...
def non_credibility_index(
    *,
    ...
    warn_deprecated(f"{_HERE}.non_credibility_index", f"{_HOME}.non_credibility_index")
...
def chi2_confidence_intervals(*, dim: int, percentile: float) -> Any:
    ...
    warn_deprecated(f"{_HERE}.chi2_confidence_intervals", f"{_HOME}.chi2_confidence_interval")
