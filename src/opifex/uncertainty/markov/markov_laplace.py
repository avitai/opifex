...
def predict_markov_laplace_gp(
    *,
    ...
    # For each test time t*, find the closest preceding training index
    # via right-sided searchsorted; use index 0 (with mean=0,
    # cov=P_∞) when t* precedes the first training point.
