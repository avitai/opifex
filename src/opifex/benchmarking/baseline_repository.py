...
This module provides a repository for storing and retrieving baseline
performance metrics for PDEBench datasets. It enables comparison of
new models against established benchmarks.

Key Features:
- Storage and retrieval of baseline performance metrics
- Comparison utilities for model evaluation
- Support for multiple model types and datasets
- Extensible baseline database

Following Critical Technical Guidelines:
- JAX-native computations for consistency
...
class BaselineRepository:
    ...
    This class manages a database of baseline performance metrics for
    standard PDEBench datasets, enabling comparison of new models
    against established benchmarks.
    """

    def __init__(self, baseline_data_path: str | None = None):
        """
    ...
    def compare_to_baseline(
        ...
        for metric in metrics_to_compare:
            ...
            # relative change
            if metric.lower() in ["mse", "mae", "rmse", "relative_error", "mape"]:
