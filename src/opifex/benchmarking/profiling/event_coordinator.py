...
class ProfilingTimeline:
    ...
    def __init__(self) -> None:
        """Initialize empty profiling timeline."""
        ...
        try:
            ...
            if enable_jax_profiler and self._jax_trace_dir:
                try:
                    ...
                    pass  # Ignore errors during profiler cleanup
