...
from .deeponet.base import DeepONet
...
from .fno.base import FourierLayer, FourierNeuralOperator
...
# Graph operators
from .graph.gno import GraphNeuralOperator, MessagePassingLayer
from .physics.attention import PhysicsAwareAttention, PhysicsCrossAttention

# Physics-informed operators
from .physics.informed import PhysicsInformedOperator

# GINO - Geometry-informed operators
from .specialized.gino import (
    create_3d_gino,
