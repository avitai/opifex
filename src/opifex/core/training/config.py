...
class TrainingConfig:
    ...
    Attributes:
        ...
        gradient_checkpointing: Whether to enable gradient checkpointing
            (rematerialization) to trade compute for memory.
        gradient_checkpoint_policy: Optional checkpoint policy name from
            artifex's CHECKPOINT_POLICIES (e.g. 'dots_saveable').
    ...
    gradient_checkpoint_policy: str | None = None
