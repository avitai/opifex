...
class GradNormBalancer(nnx.Module):
    ...
    def __init__(
        ...
        *,
        ...
        # Track initial losses (nnx.Variable for JAX array storage)
        self._initial_losses: nnx.Variable = nnx.Variable(None)  # type: ignore[assignment]
    ...
    def set_initial_losses(self, losses: Float[Array, ...]) -> None:
        ...
        """
        self._initial_losses.value = losses
    ...
    def get_initial_losses(self) -> Float[Array, ...] | None:
        ...
        """
        return self._initial_losses.value
