...
- **[Working Examples](examples/working-examples.md)** - Runnable examples and demonstrations
- **[PDE Solving](examples/pde-solving.md)** - Partial differential equation examples
- **[Quantum Chemistry](examples/quantum-chemistry.md)** - Molecular and quantum examples
- **[Fluid Dynamics](examples/fluid-dynamics.md)** - Computational fluid dynamics
- **[Materials Science](examples/materials.md)** - Materials modeling examples
