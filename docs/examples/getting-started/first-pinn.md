...
- [`Interval`](../../../api/geometry/interval.md) — 1D geometry class
- [`create_poisson_pinn`](../../../api/neural/pinns.md) — PINN factory function
- [`PINNSolver`](../../../api/solvers/pinn.md) — High-level PINN solver
- [`PINNConfig`](../../../api/solvers/pinn.md) — Solver configuration
- [`poisson_residual`](../../../api/solvers/pinn.md) — Poisson residual factory
