...
| Grad checkpoint | `torch.checkpoint` | N/A | Config flag | `TrainingConfig(gradient_checkpointing=True)` |
...
- **Python Script**: [`examples/models/fno_darcy_comprehensive.py`](https://github.com/avitai/opifex/blob/main/examples/models/fno_darcy_comprehensive.py)
- **Jupyter Notebook**: [`examples/models/fno_darcy_comprehensive.ipynb`](https://github.com/avitai/opifex/blob/main/examples/models/fno_darcy_comprehensive.ipynb)
...
| Simple SFNO | [`examples/models/sfno_climate_simple.py`](https://github.com/avitai/opifex/blob/main/examples/models/sfno_climate_simple.py) | Quick reference for climate modeling |
...
| Example | Location | Demonstrates |
|---------|----------|--------------|
| FNO Darcy | [`examples/models/fno_darcy_comprehensive.py`](https://github.com/avitai/opifex/blob/main/examples/models/fno_darcy_comprehensive.py) | Full FNO tutorial |
...
| Example | Location | Demonstrates |
|---------|----------|--------------|
| Full Profiling | [`examples/comprehensive_profiling_demo.py`](https://github.com/avitai/opifex/blob/main/examples/comprehensive_profiling_demo.py) | Advanced performance analysis |
| Neural Operator Benchmark | [`examples/comparative_studies/neural_operator_benchmark.py`](https://github.com/avitai/opifex/blob/main/examples/comparative_studies/neural_operator_benchmark.py) | Cross-architecture comparison |
