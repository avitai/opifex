...
# %%
def compute_relative_l2(predictions: jax.Array, targets: jax.Array) -> jax.Array:
...
def main() -> dict[str, float | int]:
    """Train an FNO on Darcy flow and evaluate zero-shot super-resolution."""
    print("=" * 70)
    ...
    return {
        ...
        "rel_l2_error_32": float(rel_l2_32),
        "rel_l2_error_64": float(rel_l2_64),
