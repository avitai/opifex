...
# ## Run the example
#
# Sets up collocation points, trains the PINN, evaluates against the
# analytical solution, and saves the visualizations.


# %%
def main() -> dict[str, float | int]:
    """Train a Poisson PINN, evaluate against the analytical solution, and plot."""
    print("=" * 70)
    ...
    l2_error = float(jnp.sqrt(jnp.sum((u_pred_grid - u_exact) ** 2) / jnp.sum(u_exact**2)))
